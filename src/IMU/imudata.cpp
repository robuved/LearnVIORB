...
double IMUData::_gyrBiasRw2 = 1.0e-6*1.0e-6/**10*/;  //2e-12*1e3
double IMUData::_accBiasRw2 = 2.0e-3*2.0e-3/**10*/;  //4.5e-8*1e2
...
Matrix3d IMUData::_gyrMeasCov = Matrix3d::Identity()*2.0e-3*2.0e-3/**100*/;       // sigma_g * sigma_g / dt, ~6e-6*10
Matrix3d IMUData::_accMeasCov = Matrix3d::Identity()*2.0e-3*2.0e-3;       // sigma_a * sigma_a / dt, ~8e-4*10
